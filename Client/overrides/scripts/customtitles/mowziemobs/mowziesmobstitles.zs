...
game.setLocalization("title.mowziesmobs.kill_naga", "§aThe Naga Fiend");
game.setLocalization("title.mowziesmobs.steal_ice_crystal", "§9The §bSnatcher");
game.setLocalization("title.mowziesmobs.kill_frostmaw", "§9§lThe Frigid Fighter");
game.setLocalization("title.mowziesmobs.kill_barakoana", "§6§lThe King Slayer");
game.setLocalization("title.mowziesmobs.kill_ferrous_wroughtnaut", "§8§lThe Titan Buster");
