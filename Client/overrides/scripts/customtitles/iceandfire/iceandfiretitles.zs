...
game.setLocalization("title.iceandfire.iceandfire.rotten_egg", "§eOf The Bad Batch");
game.setLocalization("title.iceandfire.iceandfire.gorgon_head", "§8The Stonecold");
game.setLocalization("title.iceandfire.iceandfire.kill_if_dragon", "§cThe Blades Initiate");
...
game.setLocalization("title.iceandfire.iceandfire.kill_troll", "§9The Troll Hunter");
game.setLocalization("title.iceandfire.iceandfire.tame_amphithere", "§aThe Jungle Navigator");
game.setLocalization("title.iceandfire.iceandfire.kill_myrmex", "§aThe Bug Smasher");
game.setLocalization("title.iceandfire.iceandfire.kill_cyclops", "§c§lThe Goliath Tormentor");
game.setLocalization("title.iceandfire.iceandfire.kill_sea_serpent", "§b§lThe Leviathan Pursuer");
